...
insert into customer(date_of_birth, email, firstname, lastname, password, phone_number, token, token_created, is_activated)
values (now(), "gerdenebat@mum.edu", "Ganzorig", "Erdenebat", "password", "99999999", "8md9Eb1aGDyfe259nnA4aS3ezB3ySEv8TLsVGFKPPCI=", now(), "Y");
